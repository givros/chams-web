...
http.createServer((req,res)=>{
  ...
  if (!file.startsWith(root+path.sep) || !['index.html','preview.html','goal.html','style.css','app.js','weather-course.js','game-course.js','three.bundle.js','three-runtime.js','platformer-runtime.js','platformer-assets.js','platformer-lessons.js','engine.js','mountains.png','station.png'].includes(path.relative(root,file))) {res.writeHead(404); return res.end('Not found');}
