...
assert.equal(course[19].prepare(course[18].solution).html,'','Web starts blank');
assert.ok(!course[15].prepare(course[4].solution).js.includes('sauter'),'2D starts a new project');
